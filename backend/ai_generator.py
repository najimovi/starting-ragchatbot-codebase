...
class SequentialToolState:
    ...
    def add_tool_results(self, results: list[dict[str, Any]], round_num: int):
        ...
        self.tool_results_history.append({"round": round_num, "results": results})
...
"""
    ...
    def _generate_simple_response(
        ...
        system_content = self._build_system_prompt(
            conversation_history=conversation_history, round_number=0, max_rounds=0
        )
    ...
    def _execute_sequential_tools(
        self,
        state: SequentialToolState,
            ...
            if content_block.type == "tool_use":
                try:
                    ...
                    if not isinstance(tool_name, str):
                        ...
                        logger.warning(
                            f"Tool name was not a string: {content_block.name}"
                        )
    ...
    def _generate_final_response(
        self, state: SequentialToolState, system_prompt: str
    ) -> str:
        """
...
"""
    ...
    def _handle_tool_execution(
        ...
        return self._generate_final_response(state, base_params["system"])
