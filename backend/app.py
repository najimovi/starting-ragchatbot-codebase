...
class QueryResponse(BaseModel):
    ...
    answer: str
    sources: list[str | dict[str, str]]  # Support both string and dict with text/link
    session_id: str
...
async def clear_session(request: ClearSessionRequest):
    ...
    try:
        # Clear the session in the session manager
        ...
        return ClearSessionResponse(
            success=False, message=f"Failed to clear session: {str(e)}"
        )
