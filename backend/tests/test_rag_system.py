...
class TestRAGSystem:
    ...
    def test_content_search_query(self, rag_system):
        ...
        mock_final.content = [
            Mock(text="MCP is the Model Context Protocol that enables AI integration.")
        ]
    ...
    def test_filtered_search_query(self, rag_system):
        ...
        mock_final.stop_reason = "end_turn"
        mock_final.content = [
            Mock(text="Lesson 2 of MCP covers the architecture components.")
        ]
    ...
    def test_course_specific_query(self, rag_system):
        ...
        mock_response.content = [
            Mock(
                ...
                name="search_course_content",
                id="tool_3",
                input={"query": "course content", "course_name": "Advanced Retrieval"},
            )
        ]
        ...
        mock_final.content = [
            Mock(
                text="The Advanced Retrieval course teaches embeddings and vector search."
            )
        ]
        ...
        response, sources = rag_system.query(
            "What does the Advanced Retrieval course teach?"
        )
    ...
    def test_session_management(self, rag_system):
        ...
        responses = [
            Mock(
                stop_reason="end_turn", content=[Mock(text="First response about MCP.")]
            ),
            Mock(
                stop_reason="end_turn",
                content=[Mock(text="Second response with context.")],
            ),
        ]
    ...
    def test_empty_results_handling(self, rag_system):
        ...
        mock_final.stop_reason = "end_turn"
        mock_final.content = [
            Mock(text="I couldn't find information about that topic.")
        ]
    ...
    def test_multiple_queries_different_types(self, rag_system):
        ...
        responses = [
            ...
            Mock(
                stop_reason="end_turn", content=[Mock(text="Machine learning is AI.")]
            ),
        ]
