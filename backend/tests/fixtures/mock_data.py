...
SAMPLE_COURSES = {
    "mcp": Course(
        ...
        lessons=[
            ...
            Lesson(lesson_number=3, title="Chatbot Example", lesson_link="https://example.com/lesson3"),
        ]
    ),
    "advanced_retrieval": Course(
        ...
        lessons=[
            Lesson(lesson_number=0, title="Introduction", lesson_link="https://example.com/ar-lesson0"),
            Lesson(lesson_number=1, title="Overview Of Embeddings Based Retrieval", lesson_link="https://example.com/ar-lesson1"),
            Lesson(lesson_number=2, title="Pitfalls Of Retrieval", lesson_link="https://example.com/ar-lesson2"),
        ]
    )
}
...
def create_sample_search_results(query_type: str = "mcp") -> SearchResults:
    ...
    if query_type == "mcp":
        ...
        return SearchResults(
            ...
            metadata=[
                {"course_title": "Advanced Retrieval for AI with Chroma", "lesson_number": 1, "chunk_index": 0}
            ],
            distances=[0.15]
        )
        ...
        return SearchResults(
            ...
            metadata=[{"course_title": "Unknown Course", "lesson_number": None, "chunk_index": 0}],
            distances=[0.5]
        )
